...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(DSP_SCL_GPIO_Port, DSP_SCL_Pin);

    HAL_GPIO_DeInit(DSP_SDA_GPIO_Port, DSP_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(TOUCH_nCS_GPIO_Port, TOUCH_nCS_Pin);

    HAL_GPIO_DeInit(GPIOC, TOUCH_SCK_Pin|TOUCH_MISO_Pin|TOUCH_MOSI_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD14     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(GPIOD, FAN1_IN_Pin|FAN2_IN_Pin);
